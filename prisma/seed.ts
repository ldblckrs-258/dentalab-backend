...
const PERMISSIONS: {
  ...
  { resource: 'treatment_plans', action: 'read' },
  {
    ...
    action: 'read',
    scope: 'full',
    description: 'Xem toàn bộ kế hoạch điều trị',
  },
  {
    resource: 'treatment_plans',
    action: 'read',
    scope: 'metadata',
    description: 'Chỉ xem thông tin cơ bản của kế hoạch điều trị',
  },
  { resource: 'treatment_plans', action: 'update' },
  {
    resource: 'treatment_plans',
    action: 'cancel',
    description: 'Hủy kế hoạch điều trị (giữ lại lịch sử)',
  },
  ...
  { resource: 'schedule_overrides', action: 'read' },
  {
    ...
    action: 'update',
    description: 'Chỉnh sửa yêu cầu thay đổi lịch trực',
  },
  {
    resource: 'schedule_overrides',
    action: 'review',
    description: 'Duyệt hoặc Từ chối yêu cầu thay đổi lịch trực',
  },
  {
    resource: 'schedule_overrides',
    action: 'cancel',
  ...
  { resource: 'clinical_notes', action: 'read' },
  {
    ...
    action: 'read',
    scope: 'full',
    description: 'Xem toàn bộ nội dung ghi chú lâm sàng',
  },
  { resource: 'clinical_notes', action: 'update' },
  {
    resource: 'clinical_notes',
    action: 'sign',
    description: 'Ký xác nhận ghi chú lâm sàng',
  },
  {
    resource: 'clinical_notes',
    action: 'addendum',
    description: 'Thêm ghi chú bổ sung vào ghi chú lâm sàng đã ký',
  },
  { resource: 'clinical_notes', action: 'delete' },
